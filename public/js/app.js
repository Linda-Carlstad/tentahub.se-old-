...
var Swedish = __webpack_require__(/*! flatpickr/dist/l10n/sv.js */ "./node_modules/flatpickr/dist/l10n/sv.js")["default"].sv;
...
if (document.querySelector('input[type=file]')) {
  var fileInputManual, fileInputAutomatic, fileInput;
  ...
  if (document.querySelector('#file-upload-manual input[type=file]')) {
    ...
    fileInputManual.onchange = function () {
      console.log(fileInputManual);

      if (fileInputManual.files.length > 0) {
        var fileName = document.querySelector('#file-upload-manual .file-name');
  ...
  if (document.querySelector('#file-upload-automatic input[type=file]')) {
    ...
    fileInputAutomatic.onchange = function () {
      if (fileInputAutomatic.files.length > 0) {
        var fileName = document.querySelector('#file-upload-automatic .file-name');
...
__webpack_require__(/*! /Users/felixwetell/Documents/GitHub/tentahub.se/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/felixwetell/Documents/GitHub/tentahub.se/resources/sass/app.scss */"./resources/sass/app.scss");
