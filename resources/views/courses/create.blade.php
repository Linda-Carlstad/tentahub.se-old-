        ...
        <div class="column is-half">
            ...
            <form class="" method="POST" action="{{ route( 'courses.store' ) }}">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input id="code" class="input {{ $errors->has('code') ? ' is-danger' : '' }}" name="code" type="text" required>
                    </div>
                    @error( 'code' )
                        <span class="has-text-danger" role="alert">
                            {{ $message }}
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input id="points" class="input {{ $errors->has('points') ? ' is-danger' : '' }}" name="points" type="number" required>
                    </div>
                    @error( 'points' )
                        <span class="has-text-danger" role="alert">
                            {{ $message }}
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input id="url" class="input {{ $errors->has('url') ? ' is-danger' : '' }}" name="url" type="text">
                    </div>
                    @error( 'url' )
                        <span class="has-text-danger" role="alert">
                            {{ $message }}
